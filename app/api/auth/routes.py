...
GITHUB_DISABLED = '<a href="/auth/login/github" class="btn btn-github" style="opacity:.65">🐙 Configure GitHub OAuth</a>'
GOOGLE_DISABLED = '<a href="/auth/login/google" class="btn btn-google" style="opacity:.75;color:#1f2937">🔵 Configure Google OAuth</a>'


def _login_page(error: str = "") -> HTMLResponse:
    error_block = f'<div class="error">⚠️ {escape(error)}</div>' if error else ""
